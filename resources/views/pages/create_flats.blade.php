        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-file"></i> New Flats Entry
                    </li>
                </ol>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('create_flats') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="number_of_toilets"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Choose the flat Image</small>
                                    </div>
