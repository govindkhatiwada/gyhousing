...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('frontend/assets/css/responsiveslider.css')}}">
...
@include('frontendviews.includes.nav')
@yield('slider')
...
<script src="{{URL::asset('frontend/assets/js/responsiveslider.min.js')}}"></script>
